        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("read:employees",
                    policy => policy.Requirements.Add(new HasScopeRequirement("read:employees", domain)));
                options.AddPolicy("create:employees",
                    policy => policy.Requirements.Add(new HasScopeRequirement("create:employees", domain)));
            });
        }
